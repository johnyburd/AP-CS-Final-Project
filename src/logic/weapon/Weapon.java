...
public class Weapon
{
  ...
  public static Weapon[] weaponArray = {new Weapon(4, -1, 0, "Fist"), new Weapon(7, 15, 2, "Dull Sword"), new Weapon(25, 150, 2.1, "Legendary Sword of Awesome"), new Weapon(6, 20, 4, "Spear")};
}
